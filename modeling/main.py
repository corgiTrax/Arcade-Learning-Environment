...
NUM_CLASSES=6
BASE_FILE_NAME = "/scratch/cluster/zhuode93/dataset/6_Apr-13-19-14-59"
...
expr = MU.ExprCreaterAndResumer(MODEL_DIR,postfix="zeros")
...
if resume_model:
    ...
    model=Model(inputs=[imgs, gaze_heatmaps], outputs=[logits, prob])
