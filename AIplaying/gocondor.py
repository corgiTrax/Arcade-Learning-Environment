...
if len(sys.argv) < 3:
  print "Usage: %s <GAME_NAME|all> <MODEL_NAME(imgOf|baseline|imgOnly)>" % __file__ 
...
if sys.argv[2] == 'imgOf':
    main(create_bgrun_sh_content_imgOf_model)
elif sys.argv[2] == 'baseline':
    main(create_bgrun_sh_content_baseline_model)
else:
