...
if resume_model:
    ...
    conv1=L.Conv3D(32, (8,8,3), strides=(4,4,1), padding='valid')
    x = conv1(x)
    ...
    conv2=L.Conv3D(64, (4,4,3), strides=(2,2,1), padding='valid')
    x = conv2(x)
    ...
    conv3=L.Conv3D(64, (3,3,3), strides=(1,1,2), padding='valid')
    x = conv3(x)
