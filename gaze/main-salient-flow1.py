...
if not predict_mode: # if train
    ...
    expr = MU.ExprCreaterAndResumer(MODEL_DIR, postfix="2ch_dp" + str(dropout) + '_shape' + str(heatmap_shape))
...
if resume_model:
    ...
    r = L.Concatenate(axis=3)([x_output, y_output])
    r = L.Conv2D(1, (1,1), strides=1, padding='valid')(r)
    outputs = L.Activation(MU.my_softmax)(r)
