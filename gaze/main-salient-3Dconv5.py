...
if resume_model:
    ...
    conv2=L.Conv3D(64, (4,4,2), strides=(2,2,1), padding='valid')
    x = conv2(x)
    ...
    conv3=L.Conv3D(64, (3,3,2), strides=(1,1,2), padding='valid')
    x = conv3(x)
    ...
    conv4=L.Conv3D(128, (2,2,3), strides=(1,1,2), padding='valid')
    x = conv4(x)
