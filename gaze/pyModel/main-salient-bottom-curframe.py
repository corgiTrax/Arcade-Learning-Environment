...
if GAME_NAME == 'seaquest':
    ...
    MODEL_DIR = "BottomUp/Breakout" 

LABELS_FILE_TRAIN = BASE_FILE_NAME + '-train.txt' 
LABELS_FILE_VAL =  BASE_FILE_NAME + '-val.txt' 
GAZE_POS_ASC_FILE = BASE_FILE_NAME + '.asc'
PREDICT_FILE_VAL = BASE_FILE_NAME.split('/')[-1] + '-bottom_curframe'
BATCH_SIZE = 50
num_epoch = 70
...
if not predict_mode: # if train
    ...
    model.fit(bu.train_bottom, d.train_GHmap, BATCH_SIZE, epochs=num_epoch,
        validation_data=(bu.val_bottom, d.val_GHmap, d.val_weight),
    ...
    score = model.evaluate(bu.val_bottom, d.val_GHmap, BATCH_SIZE, 0, sample_weight=d.val_weight)
    ...
    val_score = model.evaluate(bu.val_bottom, d.val_GHmap, BATCH_SIZE, 0, d.val_weight)
    ...
    val_pred = model.predict(bu.val_bottom, BATCH_SIZE)
    print "Predicted."
