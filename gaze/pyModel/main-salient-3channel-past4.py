...
PREDICT_FILE_VAL = BASE_FILE_NAME.split('/')[-1] + '-3channel_past4'
BATCH_SIZE = 50
num_epoch = 70
...
if not predict_mode: # if train
    ...
    expr = MU.BMU.ExprCreaterAndResumer(MODEL_DIR, postfix='pKf_dp%.1f_k%ds%d' % (dropout,k,strides))
...
bu=IU.Dataset_BottomUp_PastKFrames(LABELS_FILE_TRAIN, LABELS_FILE_VAL, SHAPE, k, strides, 0)
