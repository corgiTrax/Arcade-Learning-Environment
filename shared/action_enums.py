...
def action_map(k, game):
    ...
    if game == "pong":
        ...
        # be very careful with composed actions
        if k[pygame.K_SPACE] and k[pygame.K_DOWN] and k[pygame.K_LEFT]: return PLAYER_A_DOWNLEFTFIRE
        elif k[pygame.K_SPACE] and k[pygame.K_DOWN] and k[pygame.K_RIGHT]: return PLAYER_A_DOWNRIGHTFIRE
        elif k[pygame.K_SPACE] and k[pygame.K_UP] and k[pygame.K_LEFT]: return PLAYER_A_UPLEFTFIRE 
        elif k[pygame.K_SPACE] and k[pygame.K_UP] and k[pygame.K_RIGHT]: return PLAYER_A_UPRIGHTFIRE  
        
        elif k[pygame.K_SPACE] and k[pygame.K_DOWN]: return PLAYER_A_DOWNFIRE 
        elif k[pygame.K_SPACE] and k[pygame.K_LEFT]: return PLAYER_A_LEFTFIRE
        elif k[pygame.K_SPACE] and k[pygame.K_RIGHT]: return PLAYER_A_RIGHTFIRE
        elif k[pygame.K_SPACE] and k[pygame.K_UP]: return PLAYER_A_UPFIRE

        elif k[pygame.K_DOWN] and k[pygame.K_LEFT]: return PLAYER_A_DOWNLEFT 
        elif k[pygame.K_DOWN] and k[pygame.K_RIGHT]: return PLAYER_A_DOWNRIGHT
